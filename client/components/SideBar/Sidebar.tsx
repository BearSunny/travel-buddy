...
export default function Sidebar() {
  ...
  // We still use useTrip here to check for global loading state 
  // or to pre-fetch data, but PlanPicker now handles its own list logic.
    ...
    >
      ...
      <div className="h-full w-full overflow-hidden flex flex-col">
        {isLoading ? (
          ...
          // View 1: List of Plans
          <PlanPicker 
            onSelectTrip={(trip) => setActiveTrip(trip)}
          />
        ) : (
          // View 2: Active Trip Details
